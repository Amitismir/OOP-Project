...
public class editprofilecontroller {
    ...
    private void updateDatabase(User user) {
        ...
        try{
            ...
            System.out.println(rowsAffected + " row(s) affected.");
            query = "alter table " + oldusename.toLowerCase() + "_cardtable" + " rename to " + currentUser.username + "_cardtable" + ";";
            statement = conn.createStatement();
            rowsAffected = statement.executeUpdate(query);
            System.out.println("cardtable changed successfully!");
            System.out.println(rowsAffected + " row(s) affected.");
            query = "alter table " + oldusename.toLowerCase() + "_gamehistory" + " rename to " + currentUser.username + "_gamehistory" + ";";
            statement = conn.createStatement();
            rowsAffected = statement.executeUpdate(query);
            System.out.println("gamehistory changed successfully!");
            System.out.println(rowsAffected + " row(s) affected.");
            query = "alter table " + oldusename.toLowerCase() + "_challengerequest" + " rename to " + currentUser.username + "_challengerequest" + ";";
            statement = conn.createStatement();
            rowsAffected = statement.executeUpdate(query);
            System.out.println("challenge request changed successfully!");
            System.out.println(rowsAffected + " row(s) affected.");
