...
public class Betting implements Menu{
    @Override
    public void display() {
    ...
    public Menu handleInput(String input) {
        {
            ...
            while(Player1user.coins < coins || Player2user.coins < coins)
            {
                System.out.println("One of the users does not have enough money! Choose another amount:");
                coins = scanner.nextInt();
            }
            Player1user.coins -= coins;
            Player2user.coins -= coins;
            System.out.println(coins + " coins were deducted from Player1's account successfully!");
            System.out.println(coins + " coins were deducted from Player2's account successfully!");
            ...
            try {
                ...
                if (Player1user.HP == 0) {
                    ...
                    System.out.println((2 * coins) + " coins were added to Player2's account successfully!");
                ...
                if (Player2user.HP == 0) {
                    ...
                    System.out.println((2 * coins) + " coins were added to Player1's account successfully!");
